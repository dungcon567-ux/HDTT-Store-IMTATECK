...
<div class="ord-wrap">
    ...
    <?php if (!empty($orders)): ?>
        ...
        <div class="ord-toolbar">
            ...
            <a href="/Duan1/giaodien/duaan1-giaodien/mvc-oop-basic/index.php?act=giaodien" class="ord-back-btn">
            ...
            ?>
                <div class="ord-card">
                    ...
                    <div class="ord-card-foot">
                        <a href="/Duan1/giaodien/duaan1-giaodien/mvc-oop-basic/index.php?act=orderDetail&id=<?= $order['id'] ?>" class="ord-action primary">
                            <i class="fas fa-eye"></i> Chi tiết
                        </a>
                        <?php if ($order['status'] === 'cho_xac_nhan'): ?>
                            <a href="/Duan1/giaodien/duaan1-giaodien/mvc-oop-basic/index.php?act=confirmOrder&id=<?= $order['id'] ?>" class="ord-action success">
                                <i class="fas fa-check-circle"></i> Hoàn tất
                            </a>
                        <?php endif; ?>
                        <?php if (in_array($order['status'], $editableInfo, true)): ?>
                            <a href="/Duan1/giaodien/duaan1-giaodien/mvc-oop-basic/index.php?act=editReceiverInfo&id=<?= $order['id'] ?>" class="ord-action warning">
                                <i class="fas fa-user-edit"></i> Sửa địa chỉ
                            </a>
                        <?php endif; ?>
                        <?php if (in_array($order['status'], $cancelable, true)): ?>
                            <a href="/Duan1/giaodien/duaan1-giaodien/mvc-oop-basic/index.php?act=cancelOrder&id=<?= $order['id'] ?>"
                        ...
                        <?php if (in_array($order['status'], $reorderable, true)): ?>
                            <a href="/Duan1/giaodien/duaan1-giaodien/mvc-oop-basic/index.php?act=reorder&id=<?= $order['id'] ?>"
    ...
    <?php else: ?>
        <div class="ord-empty">
            ...
            <a href="/Duan1/giaodien/duaan1-giaodien/mvc-oop-basic/index.php?act=giaodien" class="ord-back-btn" style="background:var(--ed-rust);color:#fff;border-color:var(--ed-rust)">
