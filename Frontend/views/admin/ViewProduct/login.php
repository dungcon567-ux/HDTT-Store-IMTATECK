...
<head>
    ...
    <style>
        ...
        .left{background:#050505 !important;border-right:2px solid var(--border-2,#3a3a3a) !important;backdrop-filter:none !important}
        ...
        .brand-name{font-family:'Anton',sans-serif;text-transform:uppercase;letter-spacing:.02em}
        .brand-sub{font-family:'Space Mono',monospace}
        .hero h1{font-family:'Anton',sans-serif !important;font-weight:400 !important;background:none !important;-webkit-text-fill-color:#F4F4F0 !important;color:#F4F4F0 !important;text-transform:uppercase;letter-spacing:0}
        .hero p{font-family:'Space Mono',monospace;color:#9A9A94 !important}
        .feat{font-family:'Space Mono',monospace}
        .feat i{background:rgba(216,255,0,.12) !important;color:#D8FF00 !important;border-radius:0 !important}
        .foot{font-family:'Space Mono',monospace}
        .auth-card{background:#0A0A0A !important;border:2px solid #3a3a3a !important;border-radius:0 !important;backdrop-filter:none !important}
        .auth-card::before{display:none !important}
        .auth-title{font-family:'Anton',sans-serif !important;text-transform:uppercase;font-weight:400}
        .auth-sub{font-family:'Space Mono',monospace}
        .field label{font-family:'Space Mono',monospace;color:#9A9A94 !important}
        .field input{background:#000 !important;border:2px solid #3a3a3a !important;border-radius:0 !important;font-family:'Archivo'}
        .field input:focus{border-color:#D8FF00 !important;box-shadow:4px 4px 0 #D8FF00 !important}
